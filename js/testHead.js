/*setTimeout(function () {
  ...
  if (!isChrome){
    ...
    div1.setAttribute("id","againstIEMask");
    div1.innerText = "不支持IE浏览器，请切换到谷歌浏览器浏览";
  ...
  if (!isChrome) {
   ...
   /* divDom.innerText = "不支持IE浏览器，请切换到谷歌浏览器浏览";*/
    ...
    function titleOpenBefor80(titleDom, titleBox) {
      /* titleDom.style.backgroundColor = "#fff";
       titleDom.style.color = "#000";*/
      /*打开二级菜单*/
      if (titleBox != null) {
      ...
      /*titleDom.style.borderBottom="1px solid #bdc3c7"*/
    }
  
    function titleOpenAfter80(titleDom, titleBox) {
      // titleDom.style.backgroundColor = "bg";
      /*titleDom.style.color = "#000";*/
      /*打开二级菜单*/
      if (titleBox != null) {
        titleBox.style.display = 'block';
    ...
    function titleCloseBefore80(titleDom, titleBox) {
      /*     titleDom.style.backgroundColor = "#151737";
           titleDom.style.color = "#fff";*/
      /* titleDom.style.backgroundColor = "rgb(255,255,255,0)";
       titleDom.style.color = "#fff";*/
      if (titleBox != null) {
        titleBox.style.display = 'none';
        titleBox.style.borderTop = "none"
      }
      /* titleDom.style.borderBottom="none"*/
    }
  
    function titleCloseAfter80(titleDom, titleBox) {
      /*     titleDom.style.backgroundColor = "#151737";
           titleDom.style.color = "#fff";*/
      /*titleDom.style.backgroundColor = "rgb(255,255,255,100)";*/
      /*titleDom.style.color = "#000";*/
      if (titleBox != null) {
        titleBox.style.display = 'none';
        titleBox.style.borderTop = "none"
    ...
    /*  arkdesigndom.onclick = function (){
        window.location.href = url+"docs/ARK-Design";    //目前没有ARK-design的官网
      }*/
    ...
    /*  jflowdom.onclick = function (){
        window.location.href = url+"docs/JFlowPlugin-Version";
      }*/
    ...
    /*  spacdom.onclick = function (){
        window.location.href = url+"docs/ARK-Share";
      }*/
    ...
    useDocumentBox.innerHTML =
      ...
      '<div class="secondTitle" id="jflowDocu"><div class="secondTitle2">JFOLW</div><div class="secondContent2">项目级流程管理器</div></div>';
    ...
    title4Dom.onclick = function () {
      ...
      var scroll1 = document.documentElement.scrollTop;
      /*var srcollLeft = title4Dom.offsetLeft;*/
      ...
      if (srcollLeft < 1290) {
        ...
        /*document.getElementById("#titleBox4").style.left = "-60px";*/
        /*document.getElementById("#titleBox4").style.position = "absolute";
        document.getElementById("#titleBox4").style.left = "-147px";*/
      } else {
        if (document.getElementById("titleBox4") != null) {
      ...
      if (title4Flag) {
        ...
        titleBox4.style.display = 'none';
        /*      if (scroll1<80){
                titleCloseBefore80(title4Dom,null);
              }else {
                titleCloseAfter80(title4Dom,null);
              }*/
      }
    };
    ...
    function menu() {
      ...
      /*     if (document.getElementById("learnHowBox")!=null){
             if (scroll>(scrollRelative-100)&&scroll<(scrollRelative+700)){
               document.getElementById("learnHowBox").className = "learnHowShow"
             }else{
               document.getElementById("learnHowBox").className = "learnHowShowHidden"
             }
           }*/
    
    
      /*     if (scroll>80){
             document.getElementsByClassName("fixedHeaderContainer")[0].style.backgroundColor = "rgb(255,255,255,100)";
             document.getElementsByClassName("headerTitleWithLogo")[0].style.color = "#000"
       /!*      title1Dom.style.color = "#000";
             title2Dom.style.color = "#000";
             title3Dom.style.color = "#000";
             title4Dom.style.color = "#000";*!/
           }else {
             document.getElementsByClassName("fixedHeaderContainer")[0].style.backgroundColor = "rgb(255,255,255,0)";
             document.getElementsByClassName("headerTitleWithLogo")[0].style.color = "#fff"
      /!*       title1Dom.style.color = "#fff";
             title2Dom.style.color = "#fff";
             title3Dom.style.color = "#fff";
             title4Dom.style.color = "#fff";*!/
             title1Dom.style.borderBottom="none"
             title2Dom.style.borderBottom="none"
             title3Dom.style.borderBottom="none"
             title4Dom.style.borderBottom="none"
           }*/
    ...
    /*console.log(document.getElementById("title2").style.width);*/
  }
